...
namespace tensorium {
	...
	inline const char* to_string(ASTNodeType t) {
		switch (t) {
			...
			case ASTNodeType::Superscript:  return "Superscript";
			case ASTNodeType::Derivative:   return "Derivative";
			case ASTNodeType::Integral:     return "Integral";
			case ASTNodeType::TensorSymbol: return "TensorSymbol";
	...
	struct ASTNode {
		...
		void print(std::ostream& os, int indent = 0) const {
			...
			for (const auto& child : children) {
				if (child) child->print(os, indent + 1); 
			}
		}
		...
		private:
			...
			int get_precedence(TokenType t) const {
				switch (t) {
					...
					case TokenType::mult:
					case TokenType::divide:       return 15;
					case TokenType::pow:          return 30;
					default:                      return -1; 
				}
			}
